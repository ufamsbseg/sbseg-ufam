...
import br.com.sbseg.adapters.ListViewTutorials;
import br.com.sbseg.beans.Tutorial;
import br.com.sbseg.parsers.TutorialsParse;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listViewTutorials.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?>parent, View view, int position, long id){
				...
				intent = new Intent(TutorialsActivity.this,DetailTutorialsActivity.class);
