...
public class ListViewWorkshopAdapterSecondScreen extends BaseAdapter{
	...
	public ListViewWorkshopAdapterSecondScreen(Context context) { //Salva o context da activity que chamou esse adapter
	...
	public View getView(int position, View view, ViewGroup viewGroup) { //Trata a exibição dos itens no ListView
		...
		paperInfo.setText(paperList.get(position).getBeginning() + "-" + paperList.get(position).getEnd() + " - " + paperList.get(position).getName());
